...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { title: @music.title, track: @music.track, user_id: @music.user_id } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { title: @music.title, track: @music.track, user_id: @music.user_id } }
